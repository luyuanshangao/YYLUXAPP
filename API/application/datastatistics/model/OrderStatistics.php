...
class OrderStatistics extends Model{
    ...
    public function OrderInquire($hour_start,$hour_end,$page = 1){
        ...
        $whereSql='order_status in (100,120,200,400,407,500,600,900) AND create_on>='.$hour_start.' AND create_on<= '.$hour_end;
        $sum = $this->order->name(self::sales_order)->where($whereSql)->count();
        if(!empty($sum)){
            $list_sum['sum']=$sum;
            $order_amount= $this->order->name(self::sales_order)->where($whereSql)->sum('captured_amount_usd');
            $list_sum['order_amount'] = !empty($order_amount)?$order_amount:0;
        }else{
            $list_sum['sum']=0;
            $list_sum['order_amount'] =0;
        }
        return $list_sum;
      }
...
//            if($data['order_amount']=='65.76'){
//                var_dump($order_statistics,$data['order_amount'],$order_statistics['order_amount']);
//            }
...
//               if($data['order_amount']=='65.76'){
//                   var_dump($data);
//                   echo $this->order->name(self::order_statistics)->getLastSql();
//               }
           }
        }else{
            $data['add_time']  = time();
...
<table cellspacing="0" cellpadding="0" lang="zh-CN" style="box-sizing: border-box"><tbody style="box-sizing: border-box"><tr style="box-sizing: border-box"><td style="width: 105.36mm; min-width: 105.36mm; height: 6.88mm; font-size: 0pt; word-wrap: break-word; white-space: pre-wrap; padding: 2pt; border-image-source: initial; border-image-slice: initial; border-image-width: initial; border-image-outset: initial; border-image-repeat: initial; border: 1pt none black; direction: ltr; unicode-bidi: normal; writing-mode: lr-tb; vertical-align: top; box-sizing: border-box; background-color: transparent" class="a17"><div style="overflow-x: hidden; width: 103.95mm; box-sizing: border-box"><div class="a16" style="text-align: right; box-sizing: border-box"><span class="a11" style="font-style: normal; font-family: Tahoma; font-size: 10pt; font-weight: 400; text-decoration: none; color: black; box-sizing: border-box">时区：</span><span class="a12" style="font-style: normal; font-family: Tahoma; font-size: 10pt; font-weight: 400; text-decoration: none; color: black; box-sizing: border-box">UTC时间</span><span class="a13" style="font-style: normal; font-family: Tahoma; font-size: 10pt; font-weight: 400; text-decoration: none; color: black; box-sizing: border-box">　</span><span class="a14" style="font-style: normal; font-family: Arial; font-size: 10pt; font-weight: 400; text-decoration: none; color: black; box-sizing: border-box">执行时间：</span><span class="a15" style="font-style: normal; font-family: Arial; font-size: 10pt; font-weight: 400; text-decoration: none; color: black; box-sizing: border-box">{$Push_time}</span></div></div></td></tr></tbody></table></td><td rowspan="2" colspan="3" style="width: 524.94mm; min-width: 524.94mm; height: 6.88mm; box-sizing: border-box"></td></tr><tr style="box-sizing: border-box"><td style="height: 0.71mm; width: 0mm; box-sizing: border-box"></td><td colspan="2" style="width: 136.94mm; min-width: 136.94mm; height: 0.71mm; box-sizing: border-box"></td></tr></tbody></table></div></td></tr><tr style="box-sizing: border-box"><td class="a100xBc" style="border-image-source: initial; border-image-slice: initial; border-image-width: initial; border-image-outset: initial; border-image-repeat: initial; border: 1pt none black; box-sizing: border-box; background-color: transparent">
...
<table style="box-sizing: border-box"><tbody style="box-sizing: border-box">
<tr style="box-sizing: border-box"><td style="box-sizing: border-box"><span style="box-sizing: border-box">数据来源:</span></td></tr>
<tr style="box-sizing: border-box"><td style="box-sizing: border-box"><a href="javascript:;" style="box-sizing: border-box" target="_blank" rel="noreferrer">dx.api.com定时统计</a></td></tr>
<tr style="box-sizing: border-box"><td style="box-sizing: border-box"><span style="box-sizing: border-box">       </span></td></tr>
</tbody></table>
...
EOT;
      $dsys_config = $this->mongodb->name(self::sys_config)->where(['ConfigName'=>'OrderStatisticsMail'])->find();
        $time=date('Y/d/y H:i:s',time());
        $title='在'.$time.'执行 DXRecentPerHourSalesByDay_NEW';
      if(!empty($dsys_config['ConfigValue'])){
          ...
          foreach ($Config_array as $ke => $va) {
              if($ke==1){
                  pr($va);
                  $send_email_resp = Email::order_template($va, $title, $email_template,$CustomerID=25);
                  pr($send_email_resp);
              }
