...
class ProductActivityModel extends Model{
    ...
    public function getActivity($params){
        ...
        $query->where($where);
        $query->field("activity_title,activity_start_time,activity_end_time,activity_img,description,common,status,type");
        //活动开始时间排序
    ...
    public function selectActivity($params){
        ...
        $query->where($where);
        $query->field("activity_start_time,activity_end_time,status,type");
        //活动开始时间排序
