...
return [
     ...
     *      ['code'=>100,'name'=>'等待付款','en_name'=>'Pending Payment'],
            ...
            ['code'=>110,'name'=>'涉嫌欺诈','en_name'=>'FraudSuspected'],		//对应于OMS 71
            ['code'=>111,'name'=>'定性欺诈','en_name'=>'FraudAdjusted'],		//对应于OMS 72
     *
     ...
     *
            ['code'=>407,'name'=>'开始配货','en_name'=>'Configuring inventory'],
     *
            ...
            ['code'=>1600,'name'=>'索赔','en_name'=>'Claim'],		//对应于OMS 66和68 要变状态
     *
            ['code'=>1700,'name'=>'纠纷中','en_name'=>'Disputes'],		//对应于OMS 65  要变状态
            ['code'=>1800,'name'=>'争端订单','en_name'=>'Conflict'],
            ['code'=>1900,'name'=>'已关闭','en_name'=>'Closed'],
     *
            ['code'=>2000,'name'=>'退单','en_name'=>'Chargeback'],		//对应于OMS 67和69 要变状态
     */
