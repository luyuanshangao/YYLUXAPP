...
return [
    ...
    'cdn_url'=>'http://photo.dxinterns.com',
    ...
    'order_status'=>[
        ...
        ['code'=>920,'name'=>'售后处理中','en_name'=>'After-sales processing'],
...
选择退款时，售后原因：不想要/买错/买多、协商一致退款、缺货、未按约定时间发货、其他
    ...
    "after_sale_type"=>[
        ['code'=>1,'name'=>'换货','en_name'=>'Replacement',
            "reason"=>[ //售后原因
                ['code'=>1,'name'=>'货物损坏','en_name'=>'Defective/Does not work properly'],
                ['code'=>2,'name'=>'货不对版','en_name'=>'Different from what was ordered']
            ],
        ],
        ['code'=>2,'name'=>'退货','en_name'=>'Return',
            "reason"=>[
                ['code'=>1,'name'=>'货物损坏','en_name'=>'Cargo damage'],
                ['code'=>2,'name'=>'功能不全','en_name'=>'Non version of goods'],
     ...
     * */
    "order_refund_status"=>[
        ['code'=>1,'name'=>'退款中','en_name'=>'Refunding'],
        ['code'=>2,'name'=>'退款成功','en_name'=>'Refund successfully'],
        ['code'=>3,'name'=>'退款失败','en_name'=>'Refund failed'],
    ],
