...
//图片地址
defined('APPIMG_URL') or define('APPIMG_URL', 'https://photo.dxinterns.com');
//api_mall日志表
define('LOGS_MALL_API', "logs_mall_api");
//api_mallextend日志表
define('LOGS_MALLEXTEND_API', "logs_mallextend_api");
// 调取其他接口API通用地址
define('API_URL', "http://api.localhost.com/");
//mall商城地址
define('MALL_DOCUMENT', 'http://mall.localhost.com/');
//一小时
define('CACHE_HOUR', 3600);
//一天
define('CACHE_DAY', 3600);
//缓存key-币种菜单
...
//风控  把配置文件存缓存
define('WIND_CONTROL_VERIFICATION', 'WIND_CONTROL_VERIFICATION');
