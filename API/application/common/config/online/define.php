<?php
//mall api接口地址
defined('MALL_API') or define('MALL_API','http://api.dxinterns.com/');
//mall api接口地址
defined('CIC_API') or define('CIC_API','http://api.dxinterns.com/');
//物流跟踪号是否可用
defined('Tracking_Information_price') or define('Tracking_Information_price',2);
//产品图片地址
defined('IMG_DXCDN') or define('IMG_DXCDN', '//img.dxcdn.com');
//mall商城路径
defined('MALLDOMAIN') or define('MALLDOMAIN', '//www.dx.com');
//my站路径
defined('MYDXINTERNS') or define('MYDXINTERNS', '//home.dx.com');
//api接口地址--NOCNOC
