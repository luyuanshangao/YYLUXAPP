...
$config = [
    ...
    'cache'                  => [
        ...
        'redis'   =>  [
            'type'   => 'redis',
            // 驱动方式
            'host'       => 'redis.dxinterns.com,redis.dxinterns.com,redis.dxinterns.com',
            //端口
            'port' =>'7000,7001,7002',
        ],
        // 驱动方式
...
//        'host'       => '127.0.0.1'
     ...
     * 基础上传目录
     */
    'base_upload_dir'=>DS.'data'.DS.'public_uploads'.DS.'api'.DS.'uploads'.DS,

    /**
     * 产品图片上传目录
     */
    'product_pic_upload_dir'=>DS.'data'.DS.'public_uploads'.DS.'api'.DS.'uploads'.DS. 'product',

    'base_seller_url'=>'http://seller.dxinterns.com',
    //分页配置
    'paginate'               => [
        'type'      => 'bootstrap',
        'var_page'  => 'page',
...
$wind_control = @include APP_PATH.'/common/config/wind_control.config.php';
$risk_control = @include APP_PATH.'/common/config/risk_control.config.php';
return array_merge($config,$config_database,$config_apicode,$config_header,$config_orderstatus,$config_ordermapping,$config_base,$config_reports,$wind_control,$risk_control);
