...
class OrderParams
{
    ...
    public function getOrderInfoRules(){
        return [
            //订单ID
            ['order_id','integer','order_id必须为整型'],
            ['order_number','integer','order_id必须为整型'],
        ];
    }
     ...
     * @return array
     */
    public function orderRefunExcelGetListsRules(){
        return [
            ['store_id','integer','store_id必须为整型'],
     ...
     * @return array
     */
    public function createAdminRmaOrderRules(){
        return [
        ];
    }
    ...
    /**
     * 生成Admin换货订单(产品数据)规则校验
     * @return array
     */
    public function createAdminRmaOrderProductRules(){
        return [
            ['product_id','require|integer'],
            ['sku_id','require|integer'],
        ];
     ...
     * @return array
     */
    public function getOrderRefundSummaryRules(){
        return [
     ...
     * @return array
     */
    public function updateOrderRefundRules(){
        return [
            //退款ID
            ['refund_id','require'],
        ];
     ...
     * @return array
     */
    public function sellerDownloadOrderRules(){
        return [
            ['store_id','require|integer', '参数错误'],
        ];
    }
     ...
     * @return array
     */
    public function getOrderStatusByOrderNumRules(){
        return [
            ['order_num','require'],
        ];
    }
     ...
     * @return array
     */
    public function getOrderRefundOperationRules(){
        return [
            //订单ID
            ['order_id','require|integer'],
        ];
    ...
    public function getOrderStatusOmsRecord(){
        return [
            ['page_size','integer','page_size必须为整型'],
            ['page','integer','page必须为整型'],
            ['order_number','integer','order_number必须为整型'],
        ];
    }
    ...
    public function getOrderDiscountExceptionList(){
        return [
            ['order_number','integer','order_number必须为整型'],
            ['startCreateOn','integer','startCreateOn必须为整型'],
            ['endCreateOn','integer','endCreateOn必须为整型'],
        ];
    }
    ...
    public function getDeliveryOrder(){
        return [
            ['store_id','integer','store_id必须为整型'],
            /*['startCreateOn','require','startCreateOn不能为空'],
            ['endCreateOn','require','endCreateOn不能为空'],*/
        ];
    }
}