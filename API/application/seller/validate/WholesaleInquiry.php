...
class WholesaleInquiry extends Validate{
    protected $rule = [
        ...
        ['inquiry_id',     'number|length:1,20',        "inquiry_id Must be a number|inquiry_id Invalid parameter length"],
        ['user_id',     'number|length:1,10',                    'user_id Must be a number|user_id Invalid parameter length'],
        ['id',     'number|length:1,10',                    'id Must be a number|id Invalid parameter length'],
    ];
    protected $scene = [
        ...
        'addAnswer'   =>  ['inquiry_id',"name","user_id","description"],
        'getOneWholesaleInquiry'   =>  ['id'],
        ];
}