...
class Reports extends Validate{
    protected $rule = [
        ...
        ['report_small_type',     'require|number|length:1,5',        "report_small_type can not empty|report_small_type Must be a number|report_small_type Length must be between 1-5"],
        ...
        ['customer_name',     'chsDash|length:1,30',"customer_name Is not Valid|customer_name Length must be between 1-30"],
    ...
    protected $scene = [
        ...
        //'addReports'   =>  ['customer_id',"customer_name","","seller_id","seller_name",'report_small_type','product_url','','enclosure','email','phone','order_number','currency_code','amount','SPU','report_status'],
        'addReports'   =>  ['customer_id',"report_type","reason"],
