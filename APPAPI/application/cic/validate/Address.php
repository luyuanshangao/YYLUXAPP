...
class Address extends Validate{
    protected $rule = [
        ...
        ['Country',     'require|length:1,50',                    'Please re-select Country'],
        ['CountryCode',     'require|length:1,50',                    'Please re-select Country'],
        ['Mobile',     'length:0,20',    'Mobile Invalid parameter length'],
        ['Phone',     'length:0,20',    'Phone Invalid parameter length'],
        ['PostalCode',     'length:1,20',"PostalCode Length must be between 1-20"],
