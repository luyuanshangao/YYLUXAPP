...
class Subscriber extends Validate{
    protected $rule = [
        ...
        ['EndSendCoupon',     'number|length:1,11',                    'EndSendCoupon Must be a number|EndSendCoupon Invalid parameter length'],
    ...
    protected $scene = [
        ...
        'getSubscriberCustomers'=>['EndSendCoupon','Active','limit'],
