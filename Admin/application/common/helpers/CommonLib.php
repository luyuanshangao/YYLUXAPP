...
class CommonLib
{
    ...
    public static function rmProductCache($product_id){
        //当redis数量大的时候，不能用keys，会导致redis卡顿
        /*
        $redis = new RedisClusterBase();
        //产品详情缓存
...
//            }
     ...
     * @return array
     */
    public static function getOrderStatusChangeReasonStr($key){
        /**
         * 订单状态改变对应备注文案配置
         */
        $data = [
            /*100 Order has been created, awaiting payment.
            120 Payment is being processed
            200 Payment verified. Order is being processed.
            400 Order is being prepared for shipment.
            500 One or more of your items are not currently available. The available portion has been shipped first. The rest will be shipped later.
            600 All items have been shipped
            900 Delivery confirmed
            1400 The order has been cancelled.
            1700 PayPal Dispute Issued.*/
            ...
            '900'=>'Delivery confirmed.',
            '1400'=>'The order has been cancelled.',
            '1400-1'=>'Your order has been cancelled due to payment timeout.',
            '1700'=>'PayPal Dispute Issued.',
            '1900'=>'Close the order.',
        ];
