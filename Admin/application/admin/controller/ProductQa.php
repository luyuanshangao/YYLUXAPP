 ...
 */
class ProductQa extends Action
{
    ...
    public function index()
    {
        ...
        $param_data['type'] = ['lt',6];
        $data = $baseApi::getAdminQuestionlist($param_data);
        if($data['code'] == 200){
            $list_data = $data['data'];
        }

        return $this->fetch('',['seller_data'=>$seller_data,'admin_user'=>$admin_user,'data'=>$list_data]);
    }
    ...
    */
    public function export()
    {
        ...
        $tool = new ExcelTool();
        return  $tool ->export('Q&A留言'.date("Ymd"),$header_data,$da);
    }
