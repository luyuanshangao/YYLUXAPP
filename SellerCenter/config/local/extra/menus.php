    ...
    'menu_config'=>[
            ...
            'child_menu'=>[
                [
                    ...
                    'child_menu'=>[
                        ...
                        /*[
                            'name'=>'订单售后',
                            'url'=>Url::build('index/OrderAfterSaleApply/afterSaleApply'),
                            'flag'=>'after-sale-apply'
                        ],*/
                    ],
                ],
                /*[
        ...
        [
            'parent_menu'=>[
                ...
                //'url'=>Url::build('index/AccountManage/childAcctManage'),
...
//                        ],
                        ...
                        [
                            'name'=>'子账户管理',
                            'url'=>Url::build('index/AccountManage/childAcctManage'),
                            'flag'=>'child-account-manage-acct-manage'
                        ],
                    ],
                ],
            ],
