...
return [
     ...
     * 语言类型
     */
    'product_multiLangs'=>['en'=>'英语','cs'=>'捷克语','de'=>'德语','es'=>'西班牙语','fi'=>'芬兰语','fr'=>'法语',
                     'it'=>'意大利语','nl'=>'荷兰语','no'=>'挪威语','pt'=>'葡萄牙语','ru'=>'俄语','sv'=>'瑞典语',
                     'ja'=>'日语','ar'=>'阿拉伯语'],
    ...
    //阿里云短信配置
    'aliyun_sms'=>[
        'accessKeyId'=>'LTAIFCIx8wJ5SbqE',
        'accessKeySecret'=>'FMTv8k2FEKgvqY65sxewdQfz6AHC95',
        'SignName'=>'DX',
        'expiryTime'=>60, /** 短信验证码过期时间，单位：秒 **/
        //短信模板
        'template'=>[
            //用户注册验证码
            'userRegistVerify'=>'SMS_164060575',
        ]
    ],
